...
import net.kenji.epic_fight_mobs_plus.client.patched_renderers.p_renderers.PCatRenderer;
...
public class CatPatchRenderer extends PCatRenderer {
    public CatPatchRenderer(EntityRendererProvider.Context context, EntityType<?> entityType) {
        super(MobsPlusMeshes.CAT, context, entityType);
    }
}