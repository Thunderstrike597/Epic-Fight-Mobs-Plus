...
public class PCatRenderer extends PatchedLivingEntityRenderer<Cat, CatPatch<Cat>, CatModel<Cat>, CatRenderer, MobsPlusMesh> {

    public PCatRenderer(Meshes.MeshAccessor<MobsPlusMesh> wolf, EntityRendererProvider.Context context, EntityType<?> entityType) {
