...
public class CatArmature extends Armature {
    ...
    public final Joint tail_5;
    public final Joint tail_6;

    public CatArmature(String name, int jointNumber, Joint rootJoint, Map<String, Joint> jointMap) {
        ...
        this.tail_5 = getOrLogException(jointMap, "Tail_5");
        this.tail_6 = getOrLogException(jointMap, "Tail_6");
