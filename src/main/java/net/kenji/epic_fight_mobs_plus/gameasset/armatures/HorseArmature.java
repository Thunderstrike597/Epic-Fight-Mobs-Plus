...
public class HorseArmature extends Armature {
    public final Joint torso;
    public final Joint chest;
    public final Joint neck;
    public final Joint neckUpper;
    ...
    public HorseArmature(String name, int jointNumber, Joint rootJoint, Map<String, Joint> jointMap) {
        ...
        this.neck = getOrLogException(jointMap, "Neck");
        this.neckUpper = getOrLogException(jointMap, "Neck_Upper");
